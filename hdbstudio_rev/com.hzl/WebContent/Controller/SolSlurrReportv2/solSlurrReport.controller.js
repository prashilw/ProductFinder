sap.ui.define([
    ...
    "use strict";
    return baseController.extend("com.hzl.Controller.SolSlurrReportv2.solSlurrReport", {
        ...
        visiblitySettings: function() {
            ...
            switch (myRole) {
	            ...
	            case "ZNREC_READONLY":
		                ...
		                viewModel.visiblity.tableFieldEnabled = false;
        ...
        onSearch: function() {
            ...
            var oAjaxHandler = ajaxHandler.getInstance();
            oAjaxHandler.setProperties("QueryTemplate", "SAP_ZN_REC/SOLUTION_SLURRY1/QRY/XQRY_SOLUNSLUR_QTY_DIS");
        ...
        onUpdate: function() {
            ...
            var oAjaxHandler = ajaxHandler.getInstance();
            oAjaxHandler.setProperties("QueryTemplate", "SAP_ZN_REC/SOLUTION_SLURRY1/QRY/XQRY_SOLUNSLUR_QTY_UPDATE");
        ...
        totalZincMic: function(){
            var oAjaxHandler = ajaxHandler.getInstance();
            oAjaxHandler.setProperties("QueryTemplate", "SAP_ZN_REC/SOLUTION_SLURRY1/QRY/XQRY_SOLUNSLUR_TOTAL_ZN");
